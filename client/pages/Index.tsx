  ...
  const roadmapItems = [
    {
      ...
      description:
        "Fair launch on Solana. Community building. Make influencers rage quit Twitter.",
      status: "IN PROGRESS",
    },
    {
      id: "q1-2026",
      ...
      title: "NFT Drop",
      description:
        "Limited edition Trollface variants. Each one more cursed than the last.",
      status: "UPCOMING",
    },
    {
      id: "q2-2026",
      ...
      title: "CEX Listings",
      description:
        "Major exchange listings. Troll goes mainstream. Prepare for chaos.",
      status: "UPCOMING",
    },
    {
      id: "q3-2026",
      ...
      description:
        "Moon landing confirmed. Or at least that's what we're aiming for.",
      status: "UPCOMING",
    },
  ];
    ...
    <div className="min-h-screen gradient-background text-foreground">
      ...
      <section className="relative overflow-hidden pt-20 pb-32 px-4">
        ...
        <div className="absolute inset-0 -z-10">
          ...
          <div
            className="absolute bottom-0 right-1/4 w-96 h-96 bg-cyan-500/40 rounded-full blur-3xl animate-blob animate-spin-wild"
            style={{ animationDelay: "2s" }}
          ></div>
          <div
            className="absolute top-1/2 left-1/2 w-72 h-72 bg-pink-500/30 rounded-full blur-3xl animate-blob animate-pulse-wild"
            style={{ animationDelay: "4s" }}
          ></div>
          <div
            className="absolute top-1/3 right-1/3 w-80 h-80 bg-purple-600/25 rounded-full blur-3xl animate-blob animate-bounce-wild"
            style={{ animationDelay: "6s" }}
          ></div>
          <div
            className="absolute bottom-1/4 left-1/3 w-64 h-64 bg-pink-600/20 rounded-full blur-3xl animate-float animate-stretch"
            ...
            <div className="space-y-8 animate-slide-up">
              <div className="space-y-4">
                <h1 className="text-5xl md:text-7xl font-bold leading-tight">
                  <span
                    className="bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 text-transparent bg-clip-text animate-gradient-flow animate-bounce-wild"
                ...
                <p
                  className="text-2xl text-cyan-400 font-bold animate-slide-in-from-left animate-pulse-wild"
                ...
                {[
                  {
                    icon: "⚡",
                    title: "Fair Launch",
                    desc: "No presale, no team allocation. Just pure community power.",
                    delay: "0",
                  },
                  {
                    icon: "🔥",
                    title: "Liquidity Burned",
                    desc: "Zero rug pull risk. Your investment is protected.",
                    delay: "0.1s",
                  },
                  {
                    icon: "🚀",
                    title: "Community Driven",
                    desc: "Governed by holders. Your voice matters.",
                    delay: "0.2s",
                  },
                ].map((item, idx) => (
                  <div
                  ...
                  >
                    <div className="flex items-start gap-3 group hover:translate-x-3 transition-all duration-300 hover:scale-105">
                      <span
                        className="text-3xl group-hover:animate-spin-wild group-hover:inline-block"
      ...
      <section
        id="about"
        className="py-20 px-4 gradient-background bg-gradient-to-b from-transparent via-purple-900/20 to-transparent"
      >
        <div className="max-w-6xl mx-auto">
              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    $TROLL trolled the market. $TROLLFACE2 trolls your
                    portfolio—in a good way. This isn't just a sequel; it's an
                    evolution. Where $TROLL left memes, $TROLLFACE2 leaves
                    moonprints.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    No rugs here, just troll bridges to cross. Community-driven,
                    liquidity burned, and ready to troll the crypto world one
                    meme at a time. Are you ready to join the chaos?
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6 animate-slide-in-from-right">
                <div className="glass-effect backdrop-blur-xl p-8 space-y-6 hover:border-primary/50 transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/30 hover:bg-white/15">
                  {[
                    ...
                    <div
                      key={idx}
                      className="flex items-start gap-4 pb-6 border-b border-white/10 last:border-b-0 last:pb-0 group hover:translate-x-2 transition-all duration-300 hover:bg-white/5 px-2 rounded-lg -mx-2"
                    >
                      <div className="text-3xl group-hover:scale-125 group-hover:animate-bounce transition-all duration-300 origin-left">
                        {item.icon}
                      </div>
                      <div>
                        <p className="text-sm text-muted-foreground mb-1 group-hover:text-cyan-400 transition-colors">
                          {item.label}
                        </p>
                ...
                <div className="glass-effect backdrop-blur-xl p-6 text-center hover:border-cyan-400/50 transition-all duration-300 group hover:shadow-2xl hover:shadow-cyan-400/30 hover:bg-white/10 animate-fade-in">
                  <p className="text-muted-foreground italic group-hover:text-cyan-300 transition-colors duration-300 group-hover:scale-105">
                    "This is more than a token. This is a movement. This is
                    $TROLLFACE2."
                  </p>
                </div>
              </div>
      ...
      <section
        id="tokenomics"
        className="py-20 px-4 bg-gradient-to-b from-cyan-900/20 via-purple-900/30 to-transparent"
      >
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Tokenomics</h2>
            <p className="text-xl text-muted-foreground">
              Fair launch. No presale. No team allocation. Pure chaos.
            </p>
          </div>
      ...
      <section
        id="howto"
        className="py-20 px-4 gradient-background bg-gradient-to-b from-purple-900/20 via-transparent to-cyan-900/20"
      >
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">How to Buy</h2>
            <p className="text-xl text-muted-foreground">
              Join the chaos in 4 simple steps
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Download Phantom wallet from phantom.app and create a new wallet. Fund it with SOL from any exchange.",
              },
              {
                step: 2,
                title: "Swap on Jupiter/Raydium",
                description:
                  "Go to Jupiter or Raydium DEX. Connect your Phantom wallet and select SOL to swap.",
              },
              {
                step: 3,
              ...
              },
              {
                ...
                description:
                  "Congratulations! You are now a certified troll. HODL and spread the chaos!",
              },
            ].map((item, idx) => (
              <div
                key={idx}
          ...
          <div className="glass-effect backdrop-blur-xl p-8 text-center group hover:border-cyan-400/50 transition-all duration-300 hover:shadow-2xl hover:shadow-cyan-400/30 hover:bg-white/15 animate-fade-in">
            <p className="text-sm text-muted-foreground mb-3 group-hover:text-cyan-400 transition-colors duration-300 font-semibold">
              CONTRACT ADDRESS
            </p>
            <div className="flex items-center justify-center gap-4">
              ...
              >
                <span className="relative z-10 group-hover/btn:animate-glitch">
                  Copy
                </span>
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-pink-900/20 to-purple-900/20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-12">
            What's your troll level? Find out now!
          </p>
          <button
      ...
      <section
        id="roadmap"
        className="py-20 px-4 gradient-background bg-gradient-to-b from-cyan-900/20 via-purple-900/20 to-transparent"
      >
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Roadmap</h2>
            <p className="text-xl text-muted-foreground">
              The path to legendary trolling
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {roadmapItems.map((item) => (
              <div
                ...
                className="group relative animate-slide-up hover:animate-bounce-wild"
                style={{
                  animationDelay: `${roadmapItems.indexOf(item) * 0.1}s`,
                }}
              ...
              >
                ...
                <div className="relative glass-effect backdrop-blur-xl p-8 h-full group-hover:border-primary/50 transition-all duration-300 group-hover:shadow-2xl group-hover:shadow-purple-500/30 group-hover:-translate-y-4 group-hover:bg-white/15 group-hover:animate-pulse-wild">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <div className="text-sm font-bold text-cyan-400 mb-2 group-hover:text-purple-400 transition-colors duration-300 group-hover:scale-125 group-hover:animate-bounce-wild">
                        {item.quarter}
                      </div>
                      <h3
                        className="text-2xl font-bold group-hover:text-cyan-300 transition-colors duration-300 group-hover:animate-wave"
                  ...
                  <p
                    className="text-muted-foreground group-hover:text-gray-200 transition-colors duration-300 group-hover:animate-wave"
                    style={{ animationDuration: "3s" }}
                  >
                    {item.description}
                  </p>
      ...
      <section
        id="community"
        className="py-20 px-4 bg-gradient-to-b from-purple-900/20 to-pink-900/20"
      >
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Be part of the troll army. Connect with thousands of trolls
              worldwide.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 animate-slide-in-from-left">
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  >
                    <p
                      className={`text-4xl font-bold bg-gradient-to-r ${stat.gradient} text-transparent bg-clip-text group-hover:scale-150 group-hover:animate-flip transition-all duration-300 origin-center`}
                    >
                      {stat.value}
                    </p>
                    <p
                      className="text-muted-foreground mt-2 group-hover:text-gray-200 transition-colors duration-300 group-hover:animate-wave"
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  Follow, join, and spread the chaos across all platforms.
                </p>
              </div>
              ...
              <div className="space-y-3 animate-slide-in-from-right">
                {[
                  ...
                  >
                    <div
                      className={`w-12 h-12 bg-gradient-to-r ${social.color} rounded-lg flex items-center justify-center text-xl group-hover:shadow-2xl group-hover:scale-125 transition-all duration-300 group-hover:animate-spin-wild group-hover:text-2xl`}
                    >
                      {social.icon}
                    </div>
                    <div>
                      <p className="font-semibold text-foreground group-hover:text-cyan-300 transition-colors duration-300">
                        {social.label}
                      </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                Community-driven chaos on Solana. Troll responsibly.
              </p>
            </div>
