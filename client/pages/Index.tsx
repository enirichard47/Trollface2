    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative overflow-hidden pt-20 pb-32 px-4">
        ...
        <div className="absolute inset-0 -z-10">
          ...
          <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-cyan-500/30 rounded-full blur-3xl animate-blob" style={{ animationDelay: "2s" }}></div>
          <div className="absolute top-1/2 left-1/2 w-72 h-72 bg-pink-500/20 rounded-full blur-3xl animate-blob" style={{ animationDelay: "4s" }}></div>
        </div>
