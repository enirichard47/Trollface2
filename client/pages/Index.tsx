    ...
    <div className="min-h-screen gradient-background text-foreground">
      ...
      <section className="relative overflow-hidden pt-20 pb-32 px-4">
        ...
        <div className="absolute inset-0 -z-10">
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-purple-500/40 rounded-full blur-3xl animate-blob"></div>
          <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-cyan-500/40 rounded-full blur-3xl animate-blob" style={{ animationDelay: "2s" }}></div>
          <div className="absolute top-1/2 left-1/2 w-72 h-72 bg-pink-500/30 rounded-full blur-3xl animate-blob" style={{ animationDelay: "4s" }}></div>
          <div className="absolute top-1/3 right-1/3 w-80 h-80 bg-purple-600/25 rounded-full blur-3xl animate-blob" style={{ animationDelay: "6s" }}></div>
        </div>
            ...
            <div className="space-y-8 animate-slide-in-from-left">
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={idx}
                    className="glass-effect backdrop-blur-xl p-6 text-center hover:border-primary/50 transition-all duration-300 group hover:shadow-xl hover:shadow-purple-500/20 hover:-translate-y-2 animate-slide-up"
                    style={{ animationDelay: stat.delay }}
                  >
                    <p className={`text-4xl font-bold bg-gradient-to-r ${stat.gradient} text-transparent bg-clip-text group-hover:scale-110 transition-transform duration-300 origin-center`}>{stat.value}</p>
              ...
              <div className="space-y-3 animate-slide-in-from-right">
                {[
                  ...
                  <a
                    ...
                    className="flex items-center gap-4 p-4 glass-effect backdrop-blur-xl hover:border-primary/50 transition-all duration-300 group hover:shadow-xl hover:-translate-y-1 animate-slide-up"
                    style={{ animationDelay: social.delay }}
                  >
                    <div className={`w-12 h-12 bg-gradient-to-r ${social.color} rounded-lg flex items-center justify-center text-xl group-hover:shadow-2xl group-hover:scale-125 transition-all duration-300 group-hover:shadow-${social.shadow}`}>
                      {social.icon}
                    </div>
                    <div>
